    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commit_frequency', models.FloatField(blank=True, default=0)),
                ('issue_frequency', models.FloatField(blank=True, default=0)),
                ('core_contributors', models.IntegerField(blank=True, default=0)),
                ('comments_ratio', models.FloatField(blank=True, default=0)),
                ('iac_ratio', models.FloatField(blank=True, default=0)),
                ('sloc', models.IntegerField(blank=True, default=0)),
