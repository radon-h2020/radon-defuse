...
class BaseViewTest(APITestCase):
    ...
    @staticmethod
    def create_fixing_commit(sha: str, msg: str, date: str, is_false_positive:bool, repository_id: Repositories):
        FixingCommit.objects.create(sha=sha, msg=msg, date=date, is_false_positive=is_false_positive, repository=repository_id)
