...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/repositories'
    {path: '', pathMatch : 'full', redirectTo: 'repositories'},

    // Redirect signed in user to the '/repositories'
    //
    // After the user signs in, the sign in page will redirect the user to the 'signed-in-redirect'
    // path. Below is another redirection for that path to redirect the user to the desired
    // location. This is a small convenience to keep all main routes together here on this file.
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'repositories'},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'model-manager', loadChildren: () => import('app/modules/admin/model-manager/model-manager.module').then(m => m.ModelManagerModule)},
        ]
    },
    // {
    //     path       : '',
