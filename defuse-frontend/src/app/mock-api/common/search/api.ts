...
export class SearchMockApi
{
    ...
    private readonly _repositories: any[] = repositories;
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                const repositoriesResults = cloneDeep(this._repositories)
                ...
                // If there are repositories results...
                if ( repositoriesResults.length > 0 )
                {
                    // Normalize the results
                    repositoriesResults.forEach((result) => {

                        // Add a link
                        result.link = '/apps/repositories/' + result.id;
