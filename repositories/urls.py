...
urlpatterns = [
    ...
    path('add/', views.add_repository, name='repositories_add'), #TODO
    path('labels/', views.collect_repositories_labels, name='collect_repositories_labels'), #TODO
    path('dump/', views.dump_repositories, name='repositories_dump'),
    path('<str:id>/', views.repository_details, name='repository_details'),
    path('<str:id>/delete/', views.delete_repository, name='repository_delete'), #TODO
