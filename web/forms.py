...
class CrawlerSettingsForm(forms.Form):
    MONTHS = {
    ...
    LANGUAGE_TOSCA = 'tosca'
    LANGUAGE_CHOICES = (
        (LANGUAGE_ANSIBLE, u"Ansible"),
        (LANGUAGE_TOSCA, u"Tosca")
    )
    input_language = forms.ChoiceField(choices=LANGUAGE_CHOICES)
